    ...
    <el-container style="height: 70%;width:30%;" direction="vertical">
      ...
      <el-main>
        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm"
          ...
          <el-form-item label="Confriim Password" prop="password">
            <el-input prefix-icon="key" type="password" v-model="ruleForm.password" autocomplete="off"></el-input>
          </el-form-item>

          <el-form-item >
            <div class="log button">
              <el-button class="login" type="primary" @click="submitForm('ruleForm')" round>Confirm</el-button>
            </div>
          </el-form-item>
          ...
          <el-form-item>
            <div class="reset">
              ...
              <el-button class="reset" @click="resetForm('ruleForm')" round>Back</el-button>
              </router-link>
            </div>
          </el-form-item>
